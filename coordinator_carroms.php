<html>
<head><title></title><link rel="stylesheet" type="text/css" href="stylecarroms.css"/></head></html>
<?php 
...
$qry = 'SELECT PERSON_NAME,EVENT_COORDINATOR.PERSON_MOB_NO AS MOBILE_NO,EMAIL_ID,COMPETITION_NAME  
        FROM EVENT_COORDINATOR,ORGANISE,COMPETITION
		 ...
		 AND CLUB_NAME="CARROMS"'; 

/*Execute query*/ 
$result = mysql_query($qry);
ECHO"<CENTER>";
echo "<h1>COORDINATOR DETAILS FOR_THE EVENTS </BR>CONDUCTED BY CARROMS CLUB ARE </h1>";
