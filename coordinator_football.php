<html>
<head><title></title>
<link rel="stylesheet" type="text/css" href="stylefootball.css"/></head></html>
<?php 
...
$qry = 'SELECT PERSON_NAME,EVENT_COORDINATOR.PERSON_MOB_NO AS MOBILE_NO,EMAIL_ID,COMPETITION_NAME  
        FROM EVENT_COORDINATOR,ORGANISE,COMPETITION
		 ...
		 AND CLUB_NAME="FOOTBALL"'; 

/*Execute query*/ 
$result = mysql_query($qry);
ECHO"<CENTER>";
echo "<h1>COORDINATOR DETAILS FOR_THE EVENTS </BR>CONDUCTED BY FOOTBALL CLUB ARE </h1>";
